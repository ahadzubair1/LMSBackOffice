...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <main>
        ...
        <div class="pc-container">
            <div class="pc-content">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        <div class="card t-card membership" style="        background-color: #FBAB7E;
        background-image: linear-gradient(62deg, #FBAB7E 0%, #F7CE68 100%);">
                    ...
                    <div class="col-md-3">
                        <div class="card t-card direct-bonus" style="        background-color: #74EBD5;
        background-image: linear-gradient(90deg, #74EBD5 0%, #9FACE6 100%);">
                    ...
                    <div class="col-md-3">
                        <div class="card t-card kyc-status" style="        background-color: #FFDEE9;
        background-image: linear-gradient(0deg, #FFDEE9 0%, #B5FFFC 100%);">
                    ...
                    <div class="col-md-3">
                        <div class="card t-card direct-referral" style="        background-color: #FAACA8;
        background-image: linear-gradient(19deg, #FAACA8 0%, #DDD6F3 100%);">
                    ...
                    <div class="col-lg-8">
                        <div class="row g-3">
                            ...
                            <div class="col-lg-6">
                                <div class="card mb-4 h-100" style="        background: #232f45;
        box-shadow: inset 4px 4px 20px 0px #de0eed, inset -4px -6px 5px 0px #4680ff">
        ...
        --j: 4;">
                                        ...
                                        <h6 class="text-white position-relative" style="        background: #de0eed;
        padding: 5px 10px;
        border-radius: 70px;">Current Rank: <span class="pill">Executive</span></h6>
                                        <h6 class="text-white position-relative" style="        background: #232f45;
        padding: 5px 10px;
        border-radius: 70px;">Next Rank: <span class="pill">VIP</span></h6>
                                        <div id="typewriter" class="text-center text-white position-relative" style="        background: #232f45;
        padding: 5px 10px;
        border-radius: 70px;"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
