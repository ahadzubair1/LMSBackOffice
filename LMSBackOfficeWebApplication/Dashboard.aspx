                ...
                <div class="row g-3">
                    ...
                    <div class="col-lg-8">
                        <div class="row g-3">
                            ...
                            <div class="col-lg-6">
                                <div class="card mb-4 h-100" style="background: #232f45; box-shadow: inset 4px 4px 5px 0px #de0eed, inset -4px -6px 5px 0px #4680ff">
                                    <div class="card-body position-relative d-flex align-items-center justify-content-center flex-column">
                                        ...
                                        <div id="typewriter" class="text-center text-white position-relative" style="background: #232f45; padding: 5px 10px; border-radius: 70px;"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
