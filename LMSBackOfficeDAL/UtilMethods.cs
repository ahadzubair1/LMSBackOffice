	...
	public static class UtilMethods
	{
		...
		public static string SaveVisitorAnalytics(List<string> lstVstAly)
		{
			...
			if (lstVstAly.Count > 0 && (lstVstAly != null) && (lstVstAly.Any()))
			{
				...
				try
				{
                    con = new SqlConnection("Data Source=iconx.c3iqk6wiqyda.me-central-1.rds.amazonaws.com;Initial Catalog=LMSBO;Persist Security Info=True;User ID=iconxadmin;Password=nAn)m!T3$#31;Connect Timeout=30000");
