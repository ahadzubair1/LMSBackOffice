	...
	public static class Setup_DataAccess
	{
		...
		public static DataTable GetAllBonusTypes()
		{
			...
			try
			{
                ...
                SqlConnection Connection = new SqlConnection("Data Source=AZEEWORKBENCH\\MSSQLSERVER2019;Initial Catalog=LMSBackOffice;Persist Security Info=True;User ID=sa;Password=capslock2019;Connect Timeout=30000");
				Connection.Open();
